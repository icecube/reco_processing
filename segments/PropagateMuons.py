...
Taken from Neha: /data/user/nlad/SnowStorm/simprod-scripts/python/segments/PropagateMuons.py

Could also try
/data/user/nlad/SnowStorm/clsim/resources/scripts/photonPaths/PropagateMuons.py
/data/user/nlad/SnowStorm/Software/src/simprod-scripts/python/segments/PropagateMuons.py
/data/user/nlad/SnowStorm/Software/src/clsim/resources/scripts/photonPaths/PropagateMuons.py
/data/user/nlad/DataSets_Gen2/icerec.releases.V05-01-12.r160748.Linux-x86_64.gcc-4.8.5/lib/icecube/simprod/segments/PropagateMuons.py
"""
import os
