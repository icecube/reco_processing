...
def main():
    ...
    if args.isdata:
        ...
        # remove reco keys that are already in the file
        # todo thijs
        tray.Add('Delete',
                 keys=['SPEFit2FitParams',
    ...
    icetray.logging.log_info(pformat(millipede_params),
                             __name__)
    print(f'millipede_params:\n{pformat(millipede_params)}')
    ...
    import sys
    sys.path.append("/data/user/tvaneede/GlobalFit/reco_processing/iceprod/scripts/v1/")
