...
def selection_mask( file ):

    selections = {}

    selections["RecoETot>60TeV"] = ( file['variables']["RecoETot"] > 60e3 )
    selections["CausalQTot"] = ( file['variables']["HESE_CausalQTot"] > 6000 )
    selections["RecoETot_CausalQTot"] = (file['variables']["RecoETot"] > 60e3) & ( file['variables']["HESE_CausalQTot"] > 6000 )
