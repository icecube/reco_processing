...
def get_variables_neha( hdf_file ):
...
def get_variables( hdf_file ):
    ...
    # hese
    variables['HESE_CausalQTot'] = hdf_file['HESE_CausalQTot'].value.values

    # bdt
    variables['TauMonoDiff_rlogl'] = hdf_file['TauMonoDiff_rlogl'].value.values
    variables['Taupede_Asymmetry'] = hdf_file['Taupede_Asymmetry'].value.values
    variables['Taupede_Distance'] = hdf_file['Taupede_Distance'].value.values
    variables['Taupede1_Particles_energy'] = hdf_file['Taupede1_Particles_energy'].value.values
    variables['Taupede2_Particles_energy'] = hdf_file['Taupede2_Particles_energy'].value.values
    variables['cscdSBU_MonopodFit4_noDC_zenith'] = hdf_file['cscdSBU_MonopodFit4_noDC_zenith'].value.values
    variables['MonopodFit_iMIGRAD_PPB0_Delay_ice'] = hdf_file['MonopodFit_iMIGRAD_PPB0_Delay_ice'].value.values
    variables['CVStatistics_q_max_doms'] = hdf_file['CVStatistics_q_max_doms'].value.values
    variables['cscdSBU_VertexRecoDist_CscdLLh'] = hdf_file['cscdSBU_VertexRecoDist_CscdLLh'].value.values
    variables['MonopodFit_iMIGRAD_PPB0_energy'] = hdf_file['MonopodFit_iMIGRAD_PPB0'].energy
    variables['cscdSBU_Qtot_HLC_log'] = hdf_file['cscdSBU_Qtot_HLC_log'].value.values
    variables['Taupede_ftpFitParams_rlogl'] = hdf_file['Taupede_ftpFitParams_rlogl'].value.values
    variables['cscdSBU_MonopodFit4_noDCFitParams_rlogl'] = hdf_file['cscdSBU_MonopodFit4_noDCFitParams_rlogl'].value.values

    print(f"found {len(variables['RecoAzimuth'])} events")
