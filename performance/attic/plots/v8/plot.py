...
nufiles = ["/data/user/tvaneede/GlobalFit/reco_processing/hdf/output/v8/NuTau.h5"]
outpath = "/data/user/tvaneede/GlobalFit/reco_processing/performance/plots/v8/NuTau"
