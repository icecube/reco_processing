...
sys.path.append("/data/user/tvaneede/GlobalFit/reco_processing/performance/attic")
...
def compare_spice_ftp( nufiles, labels, outpath ):
    ...
    # length
    # plot_lenres_len( data, fit_keys = ["len_Taupede","len_Taupede"], true_key = "len_tru_tianlu",labels = labels, outpath=outpath, bins = np.linspace(0, 100,nbins) )

    plot_lenres_len( data, fit_keys = ["len_EventGeneratorDC_Thijs","len_EventGeneratorDC_Thijs"], true_key = "len_tru_tianlu",labels = labels, outpath=outpath, bins = np.linspace(0, 100,nbins) )
    plot_lenres_len( data, fit_keys = ["len_EventGeneratorDC_Max","len_EventGeneratorDC_Max"], true_key = "len_tru_tianlu",labels = labels, outpath=outpath, bins = np.linspace(0, 100,nbins) )
    ...
    # plot_medasmres_len( data, fit_keys = ["asm_EventGeneratorDC_Thijs","asm_EventGeneratorDC_Thijs"], asm_true_key = "asm_tru_tianlu", len_tru_key="len_tru_tianlu",labels=labels, outpath=outpath, bins = np.linspace(0, 100,nbins) )
    # plot_medasmres_len( data, fit_keys = ["asm_EventGeneratorDC_Max","asm_EventGeneratorDC_Max"], asm_true_key = "asm_tru_tianlu", len_tru_key="len_tru_tianlu",labels=labels, outpath=outpath, bins = np.linspace(0, 100,nbins) )
    ...
    # plot_medangres( data, fit_keys = ["EventGeneratorDC_Thijs","EventGeneratorDC_Thijs"], true_key="neha",labels=labels, outpath=outpath, bins = np.linspace(4,8,nbins) )
    # plot_medangres( data, fit_keys = ["EventGeneratorDC_Max","EventGeneratorDC_Max"], true_key="neha",labels=labels, outpath=outpath, bins = np.linspace(4,8,nbins) )


    # plot_medangres_len( data, fit_keys = ["Taupede","Taupede"], true_key="neha",labels=labels, outpath=outpath, bins = np.linspace(0, 100,nbins) )

    # plot_medangres_len( data, fit_keys = ["EventGeneratorDC_Thijs","EventGeneratorDC_Thijs"], true_key="neha",labels=labels, outpath=outpath, bins = np.linspace(0, 100,nbins) )
    # plot_medangres_len( data, fit_keys = ["EventGeneratorDC_Max","EventGeneratorDC_Max"], true_key="neha",labels=labels, outpath=outpath, bins = np.linspace(0, 100,nbins) )
...
nufiles = ["/data/user/tvaneede/GlobalFit/reco_processing/hdf/output/taureco_iceprod_v3/merged/HESE_NuTau.h5"]
labels = ["iceprod"]
outpath = "/data/user/tvaneede/GlobalFit/reco_processing/performance/attic/plots/taureco_iceprod_v3_vs_evtgen_v4_rec_v9/test"
...
# labels = ["iceprod", "local"]
# outpath = "/data/user/tvaneede/GlobalFit/reco_processing/performance/attic/plots/taureco_iceprod_v3_vs_evtgen_v4_rec_v9/NuTau"
# compare_spice_ftp(nufiles=nufiles, labels = labels,outpath=outpath)
...
# nufiles = ["/data/user/tvaneede/GlobalFit/reco_processing/hdf/output/taureco_iceprod_benchmark/HESE_evtgen_NuE.h5", 
#            "/data/user/tvaneede/GlobalFit/reco_processing/hdf/output/evtgen_v4_rec_v9/NuE.h5"]
# labels = ["iceprod", "local"]
# outpath = "/data/user/tvaneede/GlobalFit/reco_processing/performance/plots/taureco_iceprod_benchmark_vs_evtgen_v4_rec_v9/NuE"
# compare_spice_ftp(nufiles=nufiles, labels = labels,outpath=outpath)
