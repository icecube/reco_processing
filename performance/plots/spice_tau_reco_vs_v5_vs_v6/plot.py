...
def compare_spice_ftp( nufiles, labels, outpath ):
    ...
    plot_mederes( data, fit_keys = ["loge_Taupede","loge_Taupede","loge_Taupede"], true_key = "loge_tru_neha",labels=labels, outpath=outpath, bins = np.linspace(4,8,nbins) )
    ...
    plot_mederes( data, fit_keys = ["loge_Millipede","loge_Millipede","loge_Millipede"], true_key = "loge_tru_neha",labels=labels, outpath=outpath, bins = np.linspace(4,8,nbins) )
    ...
    plot_mederes( data, fit_keys = ["loge_MillipedeTrun","loge_MillipedeTrun","loge_MillipedeTrun"], true_key = "loge_tru_neha",labels=labels, outpath=outpath, bins = np.linspace(4,8,nbins) )
    ...
    plot_mederes( data, fit_keys = ["loge_RecoETot","loge_RecoETot","loge_RecoETot"], true_key = "loge_tru_neha",labels=labels, outpath=outpath, bins = np.linspace(4,8,nbins) )
    ...
    plot_medangres( data, fit_keys = ["Millipede","Millipede","Millipede"], true_key="neha",labels=labels, outpath=outpath, bins = np.linspace(4,8,nbins) )
...
nufiles = ["/data/user/tvaneede/GlobalFit/reco_processing/hdf/output/spice_tau_reco/NuTau.h5", 
           "/data/user/tvaneede/GlobalFit/reco_processing/hdf/output/v5/NuTau.h5",
           "/data/user/tvaneede/GlobalFit/reco_processing/hdf/output/v6/NuTau.h5"]
labels = ["spice", "ftp v5", "ftp v6"]
outpath = "/data/user/tvaneede/GlobalFit/reco_processing/performance/plots/spice_tau_reco_vs_v5_vs_v6/NuTau"
...
# labels = ["spice", "ftp"]
# outpath = "/data/user/tvaneede/GlobalFit/reco_processing/performance/plots/spice_tau_reco_vs_v5/NuE"
# compare_spice_ftp(nufiles=nufiles, labels = labels,outpath=outpath)
...
# labels = ["spice", "ftp"]
# outpath = "/data/user/tvaneede/GlobalFit/reco_processing/performance/plots/spice_tau_reco_vs_v5/NuMu"
# compare_spice_ftp(nufiles=nufiles, labels = labels,outpath=outpath)
