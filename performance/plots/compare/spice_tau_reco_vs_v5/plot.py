...
def compare_evtgen( nufiles, labels, outpath ):
    ...
    # length
    plot_lenres_len( data, fit_keys = ["len_Taupede","len_EventGeneratorDC_Thijs","len_EventGeneratorDC_Max"], 
    ...
    plot_len_fit( data, fit_keys = ["len_Taupede","len_EventGeneratorDC_Thijs","len_EventGeneratorDC_Max"], 
                  labels=labels, outpath=outpath, bins = np.linspace(0, 100,nbins ) )

    # energy asymmetry
    plot_medasmres_len( data, fit_keys = ["asm_Taupede","asm_EventGeneratorDC_Thijs","asm_EventGeneratorDC_Max"], 
    ...
    # energy
    plot_mederes( data, fit_keys = ["loge_Taupede","loge_EventGeneratorDC_Thijs","loge_EventGeneratorDC_Max"], 
    ...
    plot_mederes( data, fit_keys = ["loge_Monopod","loge_EventGeneratorDC_Thijs","loge_EventGeneratorDC_Max"], 
                  true_key = "loge_tru_tianlu",labels=labels, outpath=outpath, bins = np.linspace(4,8,nbins) )
    plot_mederes( data, fit_keys = ["loge_Monopod","loge_EventGeneratorDC_Thijs","loge_EventGeneratorDC_Max"], 
                  true_key = "loge_tru_neha",labels=labels, outpath=outpath, bins = np.linspace(4,8,nbins) )

    # direction
    plot_medangres( data, fit_keys = ["Taupede","EventGeneratorDC_Thijs","EventGeneratorDC_Max"], 
    ...
    plot_medangres( data, fit_keys = ["Monopod","EventGeneratorDC_Thijs","EventGeneratorDC_Max"], 
                   true_key="tianlu",labels=labels, outpath=outpath, bins = np.linspace(4,8,nbins) )
    plot_medangres( data, fit_keys = ["Monopod","EventGeneratorDC_Thijs","EventGeneratorDC_Max"], 
                   true_key="neha",labels=labels, outpath=outpath, bins = np.linspace(4,8,nbins) )

    plot_medangres( data, fit_keys = ["SPEFit16","EventGeneratorDC_Thijs","EventGeneratorDC_Max"], 
                   true_key="tianlu",labels=labels, outpath=outpath, bins = np.linspace(4,8,nbins) )
    plot_medangres( data, fit_keys = ["SPEFit16","EventGeneratorDC_Thijs","EventGeneratorDC_Max"], 
                   true_key="neha",labels=labels, outpath=outpath, bins = np.linspace(4,8,nbins) )

    plot_medangres_len( data, fit_keys = ["Taupede","EventGeneratorDC_Thijs","EventGeneratorDC_Max"], 
...
# nufiles = ["/data/user/tvaneede/GlobalFit/reco_processing/hdf/output/spice_tau_reco/NuTau.h5", "/data/user/tvaneede/GlobalFit/reco_processing/hdf/output/evtgen_v2_rec_v5/NuTau.h5"]
# labels = ["spice", "ftp"]
# outpath = "/data/user/tvaneede/GlobalFit/reco_processing/performance/plots/compare/spice_tau_reco_vs_v5/NuTau"
...
# outpath = "/data/user/tvaneede/GlobalFit/reco_processing/performance/plots/compare/spice_tau_reco_vs_v5/NuTau_EvtGen"
...
# nufiles = ["/data/user/tvaneede/GlobalFit/reco_processing/hdf/output/spice_tau_reco/NuE.h5", "/data/user/tvaneede/GlobalFit/reco_processing/hdf/output/evtgen_v2_rec_v5/NuE.h5"]
# labels = ["spice", "ftp"]
# outpath = "/data/user/tvaneede/GlobalFit/reco_processing/performance/plots/compare/spice_tau_reco_vs_v5/NuE"
# compare_spice_ftp(nufiles=nufiles, labels = labels,outpath=outpath)

nufiles = ["/data/user/tvaneede/GlobalFit/reco_processing/hdf/output/evtgen_v2_rec_v5/NuE.h5",
           "/data/user/tvaneede/GlobalFit/reco_processing/hdf/output/evtgen_v2_rec_v5/NuE.h5",
           "/data/user/tvaneede/GlobalFit/reco_processing/hdf/output/evtgen_v2_rec_v5/NuE.h5"]
labels = ["Taupede", "EvtGen Thijs", "EvtGen Max"]
outpath = "/data/user/tvaneede/GlobalFit/reco_processing/performance/plots/compare/spice_tau_reco_vs_v5/NuE_EvtGen"
compare_evtgen(nufiles=nufiles, labels = labels,outpath=outpath)
...
# nufiles = ["/data/user/tvaneede/GlobalFit/reco_processing/hdf/output/spice_tau_reco/NuMu.h5", "/data/user/tvaneede/GlobalFit/reco_processing/hdf/output/evtgen_v2_rec_v5/NuMu.h5"]
# labels = ["spice", "ftp"]
# outpath = "/data/user/tvaneede/GlobalFit/reco_processing/performance/plots/compare/spice_tau_reco_vs_v5/NuMu"
# compare_spice_ftp(nufiles=nufiles, labels = labels,outpath=outpath)
...
#            "/data/user/tvaneede/GlobalFit/reco_processing/hdf/output/evtgen_v2_rec_v5/NuMu.h5"]
# labels = ["Taupede", "EvtGen Thijs", "EvtGen Max"]
# outpath = "/data/user/tvaneede/GlobalFit/reco_processing/performance/plots/compare/spice_tau_reco_vs_v5/NuMu_EvtGen"
# compare_evtgen(nufiles=nufiles, labels = labels,outpath=outpath)
