...
def main():
    ...
    if args.isdata:
        ...
        tray.Add('I3PMTSaturationFlagger',
                 If=lambda f: f.Has(_raw))
        tray.Add(druth, hypo="track", If=lambda frame: not frame.Has('cc'))
    else:
        tray.Add(truth, hypo="track", If=lambda frame: not frame.Has('cc'))
    ...
    tray.AddModule('I3Writer',
                   ...
                   streams=[icetray.I3Frame.TrayInfo,
                            ...
                            icetray.I3Frame.Stream('S'), # needed for muons?
                            icetray.I3Frame.DAQ])
