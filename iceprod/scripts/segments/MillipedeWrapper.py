...
def MillipedeWrapper(tray, name,innerboundary, outerboundary,outeredge_x,outeredge_y,
    ...
    tray.Add(addfitstatus, Seed="TaupedeFit_iMIGRAD_PPB0")
    tray.Add(findbestfit, Seeds=Seeds, Output=name, Fitstatus='TaupedeFit_iMIGRAD_PPB0ManualFitStatus', Eventclass='HESEEventclass')
